...
uris = [
    'radio://0/80/2M/1217E7E7E7',   # cf_id 0
    # 'radio://0/80/2M/53E7E7E7E7',   # cf_id 1
    # 'radio://0/80/2M/55E7E7E7E7',   # cf_id 2
    # 'radio://0/80/2M/58E7E7E7E7',   # cf_id 3
    # 'radio://0/80/2M/1147E7E7E7',   # cf_id 4
    # 'radio://0/80/2M/57E7E7E7E7',   # cf_id 5
...
sequence = [
    ...
    # Goto starting point
    # Outer square
    (8, 0, Goto(X_outer, X_outer, Z_outer, 2)),
    (8, 1, Goto(X_outer, -X_outer, Z_outer, 2)),
    (8, 2, Goto(-X_outer, -X_outer, Z_outer, 2)),
    (8, 3, Goto(-X_outer, X_outer, Z_outer, 2)),

    # Inner square
    (8, 4, Goto(X_inner, X_inner, Z_inner, 2)),
    (8, 5, Goto(X_inner, -X_inner, Z_inner, 2)),
    (8, 6, Goto(-X_inner, -X_inner, Z_inner, 2)),
    (8, 7, Goto(-X_inner, X_inner, Z_inner, 2)),

    # Center
    (8, 8, Goto(0, 0, Z_center, 2)),
