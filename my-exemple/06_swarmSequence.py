...
URI2 = 'radio://0/80/2M/53E7E7E7E7'
URI3 = 'radio://0/80/2M/55E7E7E7E7'
...
def take_off(cf, position):
    take_off_time = 1.0
    print(f'takeoff high:{position[2]}')
    commander = cf.high_level_commander
    commander.takeoff(position[2], take_off_time)
...
def run_sequence(scf, sequence):
    try:
        ...
        for position in sequence:
            ...
            commander.go_to(position[0], position[1], position[2], 0,position[3])
