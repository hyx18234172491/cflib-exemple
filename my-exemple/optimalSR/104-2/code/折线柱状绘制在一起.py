...
ax1.set_ylabel('Receive(Ranging) rate', fontsize=20)
ax1.tick_params(axis='y', labelsize=14)
ax1.tick_params(axis='x', labelsize=14)

# 创建第二个y轴用于折线图
ax2 = ax1.twinx()
line1, = ax2.plot(x_label, y_recv_count, 'r-', label='Receive Count', marker='o')
line2, = ax2.plot(x_label, y_recv_ranging, 'g-', label='Receive Ranging', marker='s')
...
ax1.legend(lines, labels, loc='upper right', fontsize=12,ncol=2)
