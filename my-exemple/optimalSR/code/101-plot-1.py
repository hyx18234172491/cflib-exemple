...
# 加载第一个数据集
file_path = '../data/101-3-50ms-30loss-30loss-withoutLatestRx-100s-1.csv'
...
# 加载第二个数据集
new_file_path = '../data/101-3-50ms-30loss-30loss-withLatestRx-100s-1.csv'
...
plt.plot(filtered_data['timestamp'], filtered_data['ratio'], label='Without LatestRx', color='blue')
plt.plot(new_filtered_data['timestamp'], new_filtered_data['ratio'], label='With LatestRx', color='red')
