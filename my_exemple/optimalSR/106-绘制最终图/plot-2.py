...
# 绘制每个系列的数据
bars1 = ax1.bar(x - bar_width, SR1_receive_rate, width=bar_width, label='SR1 Receive', edgecolor='black')
bars2 = ax1.bar(x, SR2_receive_rate, width=bar_width, label='SR2 Receive', edgecolor='black')
bars3 = ax1.bar(x + bar_width, SR1_ranging_rate, width=bar_width, label='SR1 Ranging', edgecolor='black')
bars4 = ax1.bar(x + 2 * bar_width, SR2_ranging_rate, width=bar_width, color = "#FEDC5E",label='SR2 Ranging', edgecolor='black')
...
line4, = ax2.plot(x, SR2_ranging_count, color='#C0ACA1', marker='D', label='SR2 Ranging')
