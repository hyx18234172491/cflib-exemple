...
# Load the data
data_path = "../data/一架40ms-一架160ms.csv"
...
filtered_data['Statistic.dist1'] = filtered_data['Statistic.dist1'] + 5
filtered_data = filtered_data.iloc[500:600]
# filtered_data = filtered_data.iloc[700:800]
...
plt.plot(filtered_data['timestamp'], filtered_data['Statistic.dist1'], label='Statistic.dist1')
# plt.plot(filtered_data['timestamp'], filtered_data['Statistic.dist1'], label='Statistic.dist1', marker='x')
plt.plot(filtered_data['timestamp'], filtered_data['distance_3_to_1'], label='UAV Distance (cm)')
